...
public final class MecanumDrive {
    ...
    public static class Params {
        ...
        public double inPerTick = 0.000528424854; //Old Value: 0.0005245817151;
        public double lateralInPerTick = 0.00034728964644414027;
        public double trackWidthTicks = 22489.06095196905;

        // feedforward parameters (in tick units)
        public double kS = 1.2783227197671425; //Old Value 1.2340651635814264;
        public double kV = 0.00011035528056457365; //Old Value 0.00011291692705605586;
    ...
    public final VelConstraint slowVelConstraint =
            new MinVelConstraint(Arrays.asList(
                    kinematics.new WheelVelConstraint(PARAMS.maxWheelVel * 0.75),
                    new AngularVelConstraint(PARAMS.maxAngVel * 0.75)
            ));
    public final VelConstraint fastVelConstraint =
            new MinVelConstraint(Arrays.asList(
                    kinematics.new WheelVelConstraint(PARAMS.maxWheelVel * 2.0),
                    new AngularVelConstraint(PARAMS.maxAngVel * 2.0)
            ));
