...
public class IntakeController extends AbstractController {
    ...
    public static final double INITIAL_PIVOT_X_POSITION = 0; //Fix Value
    public static final double FULL_PIVOT_X_POSITION = 1; //Fix Value

    public static final double PASS_OFF_PIVOT_Y_POSITION = 0;
    public static final double INTAKE_PIVOT_Y_POSITION = 0.79;
    ...
    public void initialize() {
        ...
        this.intakeComponent.setPivotServoYPosition(INITIAL_PIVOT_X_POSITION);
    ...
    public void update() {
        ...
        String color = intakeComponent.detectBlockColor();
            if (distance < 1.25 && (intakeComponent.getTargetTensionServoLPosition()==FULL_TENSION_L_POSITION && (intakeComponent.getTargetTensionServoRPosition()==FULL_TENSION_R_POSITION))) {
